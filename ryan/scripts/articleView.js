...
// This function is called in the end of the new.html page because it is creating the new article to add to the blog page from that point in the code.
...
articleView.create = () => {
  ...
  let newArticleData = {
    ...
    articlePublished: $('#article-published:checked').lenght ? new Date() : null
  };     //from demo
  ...
  $('#articles').append(newArticle.tohtml()); //from demo
...
// COMMENTED: Where is this function called? Why?
// This function is called at the end of the index.html page and will load each blog article at the end of the form so that each blog post will have a structure to load to.
